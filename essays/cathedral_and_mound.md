...
In contrast, a multipurpose robot with several mission requirements represents a complex system with features that will likely need to change in the future.  A modular approach, in this case, would be highly beneficial.  Integrating such a system's necessary components into a monolithic design would be challenging and offers little flexibility in adapting the system to future extension.  However, by breaking the system down into smaller, independently designed, and testable modules, the system does gain this added flexibility, which then lends to its scalability and ease of maintenance over time.
