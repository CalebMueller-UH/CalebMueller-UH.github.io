...
An example of a monolithic design is that of a single-board computer such as the Raspberry Pi.  These types of computers include all the necessary components for the computer to operate, such as a processor, memory, and input/output interfaces, on a single circuit board.
